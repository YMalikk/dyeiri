                        ...
                        <table class="table" id="users_table">
                            ...
                            @foreach($chefs as $chef)
                                <tr>
                                    <td>{{$chef->name}}</td>
                                    <td>{{$chef->surname}}</td>
                                    @if( strpos( $chef->image, "storage/uploads/chefs" ) !== false )

                                        <td><img class="img-circle" width="75px" src="{{asset($chef->image)}}"/></td>
                                    @else
                                        <td><img class="img-circle" width="75px" src="{{$chef->image}}"/></td>
                                    @endif
