                        ...
                        <table class="table" id="users_table">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    <td>{{$user->name}}</td>
                                    <td>{{$user->surname}}</td>
                                    @if( strpos( $user->image, "storage/uploads/chefs" ) !== false )

                                        <td><img class="img-circle" width="75px" src="{{asset($user->image)}}"/></td>
                                    @else
                                        <td><img class="img-circle" width="75px" src="{{$user->image}}"/></td>
                                    @endif
