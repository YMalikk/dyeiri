            ...
            <div class="col-md-12">
                <div  class="panel">
                    <div style="max-height: 550px;;overflow: auto" class="panel-body">
                        ...
                        <form action="{{route('handleEditPlatform')}}" method="POST" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="form-group">
                                <label for="exampleInputEmail1">Delai de prise de commande :</label>
                                <input type="time" required name="time" class="form-control" style="width: 10%;display: inline;" value="{{$platform->time}}" id="exampleInputEmail1">
                            ...
                            <br>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ajouter un créneau pour les livraisons :</label>
                                <input type="time" required name="creneau" class="form-control" style="width: 10%;display: inline;" value="{{$platform->time}}" id="exampleInputEmail1">

                            </div>
                            <button type="submit" class="btn btn-alt btn-hover btn-success col-md-offset-5">
                                <span>Appliquer</span>
