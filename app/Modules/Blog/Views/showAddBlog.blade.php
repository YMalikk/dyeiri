            ...
            <div class="col-md-12">
                <div  class="panel">
                    <div style="max-height: 550px;;overflow: auto" class="panel-body">
                      ...
                      <form action="{{route('handleAddBlog')}}" method="POST" enctype="multipart/form-data">
                          {!! csrf_field() !!}
                          <div class="form-group">
                              <label for="exampleInputEmail1">Titre :</label>

                                  <input type="text" required name="title" class="form-control" id="exampleInputEmail1" placeholder="Titre">
                          ...
                          <div class="form-group">
                              <label for="exampleInputEmail1">Description :</label>
                                  ...
                                  <textarea name="description" class="form-control" required id="exampleInputEmail1" placeholder="Description"></textarea>
                          ...
                          <div class="form-group">
                              <label for="exampleInputEmail1">Image :</label>
                                  ...
                                  <input type="file" name="image" class="form-control" required id="exampleInputEmail1" placeholder="Email"/>
